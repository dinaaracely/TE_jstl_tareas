...
<html>
    ...
    <body>
        <h1>
            ...
            <c:if test="${requestScope.op == 'modicar'}" var="res" scope="request">
                Modificar
            </c:if>    
            tarea
        </h1>
        ...
        <form action="Controller" method="post">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <select name="prioridad">
                            <option value="Alta"
                                    <c:if test="${mmiTarea.prioridad == 'Alta'}"
                            ...
                            <option value="Media">
                                ...
                                >Media</option>
                            <option value="Baja"
                                    <c:if test="${mmiTarea.prioridad == 'Baja'}"
                                          var="res"  scope="request">
                                        selected
                                    </c:if>
                                    >Baja </option> 
                ...
                <tr>
                    <td>
                        <input type="hidden" name="opg" value="${requestScope}" /> 
